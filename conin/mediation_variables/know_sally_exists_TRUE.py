...
def update_fun(k, r, k_past, r_past):
    ...
    """
    m1 = (k == ("DI", ("HI", "usr/query"))) or r_past[
        0
    ]  # tracks if knowledge state has occured yet
    forbidden_transitions = (
        (k_past[0] == "EX" or k_past[0] == "WAIT_EX")
        and (k[0] == "CA" or k[0] == "WAIT_CA")
    ) or (
        (k_past[0] == "DI" or k_past[0] == "WAIT_DI")
        and (k[0] == "CA" or k[0] == "WAIT_CA")
    )
