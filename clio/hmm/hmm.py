# WEH - This should be conditionally imported, since clio_pybind11 is not a strict requirement
# from clio import clio_pybind11 as cp
import numpy as np
import random
import pprint
import math
...
from clio.hmm import Statistical_Model
